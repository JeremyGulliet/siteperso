  ...
  return (
    <section className="relative">
      <main
        ref={sectionRef}
        id="accompagnement"
        className="scroll-mt-header-responsive lg:scroll-mt-header flex flex-col items-center justify-center gap-4 bg-lightPurple py-16 md:gap-8  lg:gap-16"
      >
        ...
        >
          ...
          <motion.div
            ...
            className="hidden flex-col items-center gap-8 lg:flex lg:gap-16"
          >
            <motion.p
              variants={bubbleVariants}
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center gap-8 lg:hidden"
          >
            <Image
              src="/asset/Images/Woman thinking-bro.png"
              alt="FAQ illustration"
